...
const CommentSlider = () => {
  ...
  return(
      <Box component={"div"} sx={{mt: 10,color:"black" , justifyContent: "center", alignItems: "center"}}>
          <Slider {...options} >
              {
                  userComments.map((user, index) => (
                      <Box key={index} component={"div"} sx={{justifyContent: "center"}}>
                          ...
                          <Typography variant={"body1"} textAlign={"center"}
                                      color={"black"}>{user.fullname}</Typography>
                          <Typography variant={"body2"} textAlign={"center"} color={"balck"}
                                      sx={{mb: 2}}>{user.jobTitle}</Typography>
